...
public class LocacaoMotoServiceTest {	
	...
	private static final LocalDate DATA_INICIAL = LocalDate.of(2019, 8, 14);
	private static final LocalDate DATA_FINAL = LocalDate.of(2019, 8, 23);
	...
	public void alugarMotoPorModeloEData() throws Exception {
		...
		locacaoService.salvar(moto.getModelo(), DATA_INICIAL, DATA_FINAL, 40d);	
	...
	public void alugarCarroIndisponivel() throws Exception {		
		...
		locacaoService.salvar(moto.getModelo(), DATA_INICIAL, DATA_FINAL, 80d);			
	}
	...
	public void alterarLocacaoDeUmVeiculo()  throws Exception {
		...
		List<Locacao> locacaoList = locacaoService.buscarPorVeiculo(moto.getId(), DATA_INICIAL, DATA_FINAL);
	...
	public void deletarUmaLocacao() throws Exception {
		...
		locacaoList = locacaoService.buscarPorVeiculo(moto.getId(), DATA_INICIAL, DATA_FINAL);		
